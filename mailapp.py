...
gui.title("Mail Application")

logo=PhotoImage(file="codeclause\\logo3.png")
gui.iconphoto(False,logo)

heading = Label(text="Mail Application",bg="teal",fg="white",font="10",width="500",height="3")
...
button = Button(gui,text="Send Message",command=send_message,width="30",height="2",bg="black",fg="white")
